    ...
    <section className="relative bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 text-white h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 flex flex-col items-center text-center px-4 transform transition-opacity duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="flex space-x-6 p-4 mt-6">
          <a href="https://www.linkedin.com/in/muzamil-khan-40a9742a9/" className="px-6 py-3 bg-white text-gray-600 font-semibold rounded-full shadow-lg hover:bg-gray-300 transition duration-500 ease-in-out transform hover:-translate-y-1">
            Talk on LinkedIn
            
          </a>
          <a href="muzamilqureashi@gmail.com" className="px-6 py-3 bg-white text-gray-600 font-semibold rounded-full shadow-lg hover:bg-gray-300 transition duration-500 ease-in-out transform hover:-translate-y-1">
            Contact via Email
          </a>
        </div>
      </div>
